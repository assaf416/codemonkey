...
ActiveRecord::Schema[7.0].define(version: 2025_04_15_204428) do
  ...
  create_table "favorite_developers", force: :cascade do |t|
    t.integer "business_id"
    t.integer "developer_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["business_id"], name: "index_favorite_developers_on_business_id"
    t.index ["developer_id"], name: "index_favorite_developers_on_developer_id"
  end
